...
use orderbook_adapter::msg::OrderbookAdapterInstantiateMsg;
...
fn main() -> anyhow::Result<()> {
    ...
    let adapter = account.install_adapter::<OrderbookAdapterInterface<_>>(&[])?;

    // // Import adapter's endpoint function traits for easy interactions.
    use orderbook_adapter::msg::OrderbookAdapterQueryMsgFns;
