use orderbook::{
    ...
    msg::{
        ConfigResponse, CountResponse, OrderbookExecuteMsgFns, OrderbookInstantiateMsg, OrderbookQueryMsgFns,
    },
...
impl TestEnv<MockBech32> {
    ...
    fn setup() -> anyhow::Result<TestEnv<MockBech32>> {
        ...
        let app = publisher
            .account()
            .install_app::<OrderbookInterface<_>>(&OrderbookInstantiateMsg { count: 0 }, &[])?;
