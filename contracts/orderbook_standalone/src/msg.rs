...
pub struct OrderbookStandaloneInstantiateMsg {
...
pub enum OrderbookStandaloneExecuteMsg {
    UpdateConfig {},
...
#[cosmwasm_schema::cw_serde]
pub struct OrderbookStandaloneMigrateMsg {}

/// Standalone query messages
#[cosmwasm_schema::cw_serde]
#[derive(QueryResponses, cw_orch::QueryFns)]
pub enum OrderbookStandaloneQueryMsg {
